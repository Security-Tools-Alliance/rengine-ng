        ...
        for yaml_file in yaml_files:
            ...
            try:
                ...
                engine, created = EngineType.objects.get_or_create(
                    engine_name=engine_name, defaults={"yaml_configuration": yaml_content, "default_engine": True}
                )
                ...
                if created:
                    ...
                    self.stdout.write(self.style.WARNING(f"Engine already exists: {engine_name}"))

            except Exception as e:
                self.stdout.write(self.style.ERROR(f"✗ Failed to load {yaml_file}: {str(e)}"))
