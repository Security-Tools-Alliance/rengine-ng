...
class NotificationProcessor:
    ...
    def process_notification_batch(
        ...
        **kwargs
        ...
        try:
            # Send notifications
            sent_results = self._send_notifications(
                notification_data, ctx, batch_id, **kwargs
            )
            
            # Save notification records
            saved_results = self._save_notification_records(
                notification_data, ctx, batch_id, **kwargs
            )
    ...
    def _save_notification_records(
        ...
        **kwargs
        ...
        try:
            ...
            return {
                "saved_count": len(save_result.data.get("saved_notifications", [])),
...
def send_scan_notification_distributed(
    self,
...
def send_vulnerability_notification_distributed(
    self,
...
def send_subdomain_notification_distributed(
    self,
    subdomain_id=None,
    ctx=None,
    description=None,
...
def send_notification_orchestrator(
    self,
    scan_history_id=None,
    status=None,
    ctx=None,
