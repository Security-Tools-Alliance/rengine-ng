...
class ReportingProcessor:
    ...
    def process_report_generation_batch(
        self, scan_history_id: int, ctx: Dict[str, Any], batch_id: str, **kwargs
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            report_data = self._generate_report_data(scan_history, ctx, batch_id, **kwargs)

            # Generate report files
            report_files = self._generate_report_files(report_data, ctx, batch_id, **kwargs)

            # Save report records
            saved_results = self._save_report_records(report_files, ctx, batch_id, **kwargs)
    ...
    def _generate_report_data(
        self, scan_history: ScanHistory, ctx: Dict[str, Any], batch_id: str, **kwargs
    ) -> Dict[str, Any]:
        """Generate report data"""
        try:
            # Collect scan data
    ...
    def _generate_report_files(
        self, report_data: Dict[str, Any], ctx: Dict[str, Any], batch_id: str, **kwargs
    ) -> List[Dict[str, Any]]:
        """Generate report files"""
        report_files = []
    ...
    def _generate_json_report(
        self, report_data: Dict[str, Any], ctx: Dict[str, Any], batch_id: str
        ...
        try:
            ...
            return {"type": "json", "file_path": report_file, "size": os.path.getsize(report_file)}
    ...
    def _generate_html_report(
        ...
        try:
            ...
            return {"type": "html", "file_path": report_file, "size": os.path.getsize(report_file)}
    ...
    def _generate_csv_report(
        ...
        try:
            ...
            return {"type": "csv", "file_path": report_file, "size": os.path.getsize(report_file)}
    ...
    def _generate_pdf_report(
        ...
        try:
            ...
            return {"type": "pdf", "file_path": report_file, "size": os.path.getsize(report_file)}
    ...
    def _save_report_records(
        self, report_files: List[Dict[str, Any]], ctx: Dict[str, Any], batch_id: str, **kwargs
    ) -> Dict[str, Any]:
        """Save report records"""
        try:
            ...
            save_result = self.subdomain_processor.save_reports_batch(report_records, f"{batch_id}_reports", **kwargs)

            return {"saved_count": len(save_result.data.get("saved_reports", [])), "errors": save_result.errors}
...
def generate_scan_report_distributed(self, scan_history_id=None, ctx=None, description=None, **kwargs):
    """
...
def report(self, scan_history_id=None, ctx=None, description=None, **kwargs):
    """
    ...
    return generate_scan_report_distributed.delay(
        scan_history_id=scan_history_id, ctx=ctx, description=description, **kwargs
    ).get()
...
def generate_report(ctx=None, description=None):
    ...
    try:
        ...
        if subscan_id:
            SubScan.objects.filter(pk=subscan_id).first()
...
def generate_report_batch(self, scan_history_id=None, ctx=None, description=None, **kwargs):
    """
    ...
    try:
        # Use the distributed report generation system
        result = generate_scan_report_distributed.delay(
            scan_history_id=scan_history_id, ctx=ctx, description=description or "Report generation batch", **kwargs
        )
        ...
        return {"success": False, "error": str(e), "reports_generated": 0}


@app.task(name="generate_report_orchestrator", queue="orchestrator_queue", base=RengineTask, bind=True)
def generate_report_orchestrator(self, scan_history_id=None, ctx=None, description=None, **kwargs):
    """
