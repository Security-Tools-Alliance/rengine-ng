...
class PortScanProcessor:
    ...
    def process_port_scan_batch(
        ...
        **kwargs
        ...
        try:
            ...
            scan_results = self._execute_port_scan_commands(
                subdomains, ctx, batch_id, **kwargs
            )
            
            # Parse scan results
            parsed_results = self._parse_port_scan_results(
                scan_results, ctx, batch_id, **kwargs
            )
            
            # Save scan results
            saved_results = self._save_port_scan_results(
    ...
    def _parse_port_scan_results(
        ...
        **kwargs
        ...
        parse_result = self.nmap_parser.parse_nmap_files_batch(
            output_files, batch_id, parse_type="ports", **kwargs
        )
    ...
    def _save_port_scan_results(
        ...
        **kwargs
        ...
        if ip_data:
            ip_save_result = self.ip_processor.save_ips_batch(
                ip_data, f"{batch_id}_ips", **kwargs
            )
    ...
    **kwargs
    ...
    try:
        ...
        for i in range(0, len(subdomain_ids), batch_size):
            ...
            batch_result = processor.process_port_scan_batch(
                batch_subdomain_ids, ctx, batch_id, **kwargs
            )
        ...
        logger.info(f"Distributed port scan completed: {total_processed} subdomains processed, {total_scanned} ports scanned, {total_saved} endpoints saved")
...
def port_scan_subdomain_distributed(
    self,
    subdomain_id=None,
    ctx=None,
    description=None,
    **kwargs
    ...
    try:
        ...
        result = processor.process_port_scan_batch(
            [subdomain_id], ctx, f"port_scan_subdomain_{subdomain_id}", **kwargs
        )
...
def port_scan_range_distributed(
    self,
    ip_range=None,
    ctx=None,
    description=None,
    **kwargs
    ...
    try:
        ...
        # Process IP range
        result = processor.process_port_scan_batch(
            [], ctx, f"port_scan_range_{hash(ip_range)}", **kwargs
        )
...
def port_scan(
    ...
    **kwargs
    ...
    return port_scan_distributed.delay(
    ...
    **kwargs
    ...
    try:
        ...
        result = port_scan_distributed.delay(
            subdomain_ids=subdomain_ids,
            ctx=ctx,
            description=description or "Port scan batch",
            **kwargs
        )
    ...
    **kwargs
    ...
    try:
        ...
        result = port_scan_distributed.delay(
            subdomain_ids=subdomain_ids,
            ctx=ctx,
            description=description or "Port scan orchestration",
            **kwargs
        )
