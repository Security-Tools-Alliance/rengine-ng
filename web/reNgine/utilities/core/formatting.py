...
def format_table(data: List[Dict[str, Any]], headers: Optional[List[str]] = None, max_width: int = 80) -> str:
    """
...
def format_list(
    items: List[Any], separator: str = ", ", max_items: Optional[int] = None, truncate_suffix: str = "..."
) -> str:
    """
...
def format_dict(
    data: Dict[str, Any], key_value_separator: str = ": ", item_separator: str = ", ", max_items: Optional[int] = None
) -> str:
    """
...
def format_elapsed_time(
    start_time: Union[int, float, datetime], end_time: Optional[Union[int, float, datetime]] = None
) -> str:
    """
