...
from reNgine.utilities.core import is_iterable, replace_nulls
from reNgine.utilities.distributed.lock import DistributedLock, get_redis_connection
from reNgine.utilities.url import get_domain_from_subdomain, is_target_allowed_for_domain, is_valid_url, sanitize_url
from reNgine.utilities.database_interface import DatabaseInterface, DatabaseRecord, QueryFilter, create_database_context
...
class DistributedEndpointProcessor(DistributedDatabaseProcessor):
    ...
    def _get_or_create_subdomain(self, subdomain_name: str, ctx: Optional[Dict[str, Any]] = None) -> Optional[DatabaseRecord]:
        ...
        if technologies and endpoint:
            for tech_name in technologies:
                if tech_name:
                    ...
                    tech = self.db_interface.create_record("technology", tech_data)
