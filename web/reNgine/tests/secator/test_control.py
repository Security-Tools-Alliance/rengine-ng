...
class TestSecatorScanController(unittest.TestCase):
    ...
    def test_stop_scan_single_task(self, mock_revoke_task, mock_scan_repo_class):
    ...
    @patch("reNgine.secator.control.ScanRepository")
    @patch("secator.celery.revoke_task")
    def test_stop_scan_multiple_tasks(self, mock_revoke_task, mock_scan_repo_class):
    ...
    @patch("reNgine.secator.control.ScanRepository")
    @patch("secator.celery.revoke_task")
    def test_stop_scan_partial_revocation_failure(self, mock_revoke_task, mock_scan_repo_class):
