...
from .views import (
    ...
    GetIpDetails,
    GfList,
    GithubToolCheckGetLatestRelease,
    InitiateSubTask,
...
urlpatterns = [
    ...
    path("tools/ping_hosts/", PingHosts.as_view(), name="ping_hosts"),
    ...
    path(
        "github/tool/get_latest_releases/", GithubToolCheckGetLatestRelease.as_view(), name="github_tool_latest_release"
    ),
    path(
    ...
    path("tool/update/", UpdateTool.as_view(), name="update_tool"),
