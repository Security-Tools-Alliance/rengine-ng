...
from .views import (
    ...
    ScanStatus,
    SearchHistoryView,
    SecatorDNSRecordSave,
    SecatorEmployeeSave,
    SecatorEndpointSave,
    SecatorExploitSave,
    SecatorIPSave,
    SecatorPortSave,
    SecatorScanActivityCreate,
    SecatorScanStatusUpdate,
    SecatorSubdomainSave,
    SecatorTechnologySave,
    SecatorVulnerabilitySave,
    StartScan,
    StopScan,
...
urlpatterns = [
    ...
    # Secator hooks endpoints (for remote workers)
    path("secator/ip/", SecatorIPSave.as_view(), name="secator_ip_save"),
    path("secator/subdomain/", SecatorSubdomainSave.as_view(), name="secator_subdomain_save"),
    path("secator/port/", SecatorPortSave.as_view(), name="secator_port_save"),
    path("secator/endpoint/", SecatorEndpointSave.as_view(), name="secator_endpoint_save"),
    path("secator/technology/", SecatorTechnologySave.as_view(), name="secator_technology_save"),
    path("secator/vulnerability/", SecatorVulnerabilitySave.as_view(), name="secator_vulnerability_save"),
    path("secator/dns_record/", SecatorDNSRecordSave.as_view(), name="secator_dns_record_save"),
    path("secator/exploit/", SecatorExploitSave.as_view(), name="secator_exploit_save"),
    path("secator/employee/", SecatorEmployeeSave.as_view(), name="secator_employee_save"),
    path("secator/scan/<int:scan_id>/status/", SecatorScanStatusUpdate.as_view(), name="secator_scan_status"),
    path("secator/scan/<int:scan_id>/activity/", SecatorScanActivityCreate.as_view(), name="secator_scan_activity"),
]
