...
(function (global) {
  ...
  const MODAL_IDS = {
    ...
    WHOIS_LOOKUP: 'whoisLookupModal',
    WHOIS_LOOKUP_RESULT: 'whoisLookupResultModal',
    CMS_DETECTOR: 'cmsDetectorModal',
    CMS_DETECTOR_RESULT: 'cmsDetectorResultModal',
    CVE_DETAIL: 'cveDetailModal',
    WAF_DETECTOR: 'wafDetectorModal',
