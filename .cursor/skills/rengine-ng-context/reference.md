...
- **UI**: responsive, real-time, DataTables, charts; shared `_scan_params_block.html` template and `scan_params.js` for scan config editing (see `rengine-ng-frontend.mdc`)
